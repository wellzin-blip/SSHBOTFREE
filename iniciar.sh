...
echo "Instalando pacotes MultiHD-4G, aguarde..."
...
wget https://github.com/wellzin-blip/SSHBOTFREE/raw/main/%40admysshbot.zip -O bot.zip && unzip bot.zip > /dev/null
